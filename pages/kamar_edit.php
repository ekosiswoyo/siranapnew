								...
								<h2 class="card-inside-title">Masukan data kamar</h2>
									...
									<input type="hidden" name="kd_kamar" value="<?php echo $id; ?>">
                                        ...
                                        <b>Nama Kamar</b>
                                            ...
                                            <input type="text" class="form-control" placeholder="Nama Kamar" name="nama" value="<?php echo $dcari['Nama_Kamar']; ?>"/>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <b>Harga</b>
                                            ...
                                            <input type="text" class="form-control" placeholder="Harga" name="harga" value="<?php echo $dcari['Harga']; ?>" />
                                        </div>
                                    </div>
