							 ...
							 <form method="post" action="tambahperiksa.php" >
								...
								<!-- Penulisan untuk id_admin otomatis -->
                                 ...
                                 $link = mysqli_connect('localhost', 'root', '', 'puskesmassragi');
									...
									$query = mysqli_query($link, "SELECT max(No_periksa) as maxKode FROM periksa");
								 ...
								 ?>
                                  <div class="form-group">
										<div class="form-line">
                                        <p><b>No Periksa</b></p>
                                            <input type="text" class="form-control" placeholder="No Periksa" name="no_periksa" value="<?php echo $no_daftar; ?>" readonly />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="datepicker form-control" name="tgl_periksa" placeholder="Tanggal Periksa">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="timepicker form-control form-control" name="jam_periksa" placeholder="Jam Periksa">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Terapi" name="terapi" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Kesadaran" name="kesadaran" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Tinggi Badan" name="tinggi" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Berat Badan" name="berat" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Tekanan Darah" name="tekanan" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <a href="periksa .php" class="btn btn-round btn-round btn-default"><i class="fa fa-undo fa-fw"></i>Batal</a>
                                </div>
                                </div>
